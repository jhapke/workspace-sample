# com-chilipeppr-workspace-cnc-cam
A ChiliPeppr Workspace to run the cnc-cam.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / cnc-cam
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-cnc-cam |
| Name                  | Workspace / cnc-cam |
| Description           | A ChiliPeppr Workspace to run the cnc-cam. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/jhapke/workspace-sample/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/electricgearnuts/cnc-cam |
| Github URL            | http://github.com/jhapke/workspace-sample |
| Test URL              | https://preview.c9users.io/electricgearnuts/cnc-cam/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/jhapke/workspace-sample/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-cnc-cam"], // the id you gave your workspace
      function(myWorkspaceCncCam) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / cnc-cam just got loaded.", myWorkspaceCncCam);
        myWorkspaceCncCam.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-cnc-cam"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / cnc-cam"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace to run the cnc-cam."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/jhapke/workspace-sample/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/electricgearnuts/cnc-cam"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/jhapke/workspace-sample"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://cnc-cam-electricgearnuts.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
