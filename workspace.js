...
cprequire_test(["inline:com-chilipeppr-workspace-cnc-cam"], function(ws) {
    ...
    $('title').html("cnc-cam Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-cnc-cam", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-cnc-cam", // Make the id the same as the cpdefine id
        name: "Workspace / cnc-cam", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace to run the cnc-cam.`,
        ...
        /**
         * Load the camera widget via chilipeppr.load()
         */
         ...
         */
        loadXBOXWidget: function(callback) {
